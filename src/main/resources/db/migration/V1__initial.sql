...
CREATE INDEX idx_enrollment_course_id_status ON enrollment (course_id, status);

CREATE INDEX idx_enrollment_student_id_requested_at ON enrollment (student_id, requested_at DESC);
